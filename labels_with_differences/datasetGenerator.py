...
# Path to the base directory containing project folders (go up one level from labels_with_differences)
base_dir = os.path.join("..", "emiw_artifact", "mutation_analysis_results")
...
# Read the filtered CSV from the labeled_data_points folder (go up one level first)
csv_path = os.path.join("..", "labeled_data_points", "filtered_consolidated.csv")
...
print(f"✅ Done. Parsed {len(output_df)} mutants. Output saved to original_mutant_differences_label.csv")